...
> 🤔 주어진 범위에 있는 순서번호는 윈도우를 의미하는가
    
이들은 확인응답이 아직 없어도, 다중 패킷을 전송할 수 있다.
...
`Go-Back-n` 기법은 
    ...
    손상되거나 손실된 패킷부터 전송한 지점까지 순서대로 다시 재전송하는 기법이다.        
