...
### 드모르간의 법칙
 ![드모르간의 진리표](asset/DE_Morgan.PNG)
 논리 연산에서 논리합은 논리곱과 부정기호로, 논리곱은 논리합과 부정기호로 표현할 수 있음을 가르키는 법칙<br/>

  ![드모르간의 진리표 부정적논리](asset/DE_Morgan2.jpg)

ex) 위 표에서 알수 있는것은 a AND b와 NOT (NOT a OR NOT b)가 같다는 것을 알수있다. 드모르간의 법칙을 안다면 부정적 논리에서 NOT를 삭제할 수 있다.<br/>
-> **비용 절감**
...
**어떤 수를 뒤집고 1을 추가하여 음수를 구하는 방법**<br/>
...
#### 트릭
- **정규화** : 정수부에 1만 남기도록 소수점을 이동하고 소수점에 관한 정보를 2^n 으로 표현하는것
