...
전화번호부에 대한 테이블에 *"김길동"* 을 빠른 탐색 하고 싶은 상황이다.

전화번호부의 정렬은 성(last_name), 이름(first_name) 순서이기 때문에 복합 인덱스를 설정하는 것이 적절하다.

    +-----------+------------+---------+        +---------+-----------+---------+---------+
    | last_name | first_name | pointer |        | pointer | full_name | 데이터A | 데이터B |
    +-----------+------------+---------+        +---------+-----------+---------+---------+
    |     김    |    길동    |   _200  |        |   _200  |   김길동  |    -    |    -    |
    +-----------+------------+---------+        +---------+-----------+---------+---------+
    |     김    |     밥     |   _250  |   →    |   _250  |    김밥   |    -    |    -    |
    ...
    |     김    |    용기    |   _300  |        |   _300  |   김용기  |    -    |    -    |
    +-----------+------------+---------+        +---------+-----------+---------+---------+
    |     홍    |    길동    |  _1500  |        |  _1500  |   홍길동  |    -    |    -    |
    +-----------+------------+---------+        +---------+-----------+---------+---------+

이름만 인덱스를 설정하여 찾아낸다고 했을 때, 

누구든 성과 상관없이 길동이란 이름을 가질 수 있기 때문에 전화번호부 전체에서 찾아야하며 인덱스는 부적절하다.

    +------------+---------+        +---------+-----------+---------+---------+
    | first_name | pointer |        | pointer | full_name | 데이터A | 데이터B |
    +------------+---------+        +---------+-----------+---------+---------+
    |    길동    |   _200  |        |   _200  |   김길동  |    -    |    -    |
    +------------+---------+        +---------+-----------+---------+---------+
    |     밥     |   _250  |   →    |   _250  |    김밥   |    -    |    -    |
