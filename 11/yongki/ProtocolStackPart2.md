...
지난 주차의 `서버에 접속한다`의 [접속](https://slides.com/yongki150/week11-connect/embed)의 과정에서 TCP 오류 검출을 추가한 부분을 더해서 확인해보자.
...
`Socket.read()`는 [데이터 송·수신](https://slides.com/yongki150/week11-data/embed)하는 과정으로 확인해보자.
...
`Socket.close()`는 [말소](https://slides.com/yongki150/week11-disconnect/embed)의 과정으로 알아보자.
